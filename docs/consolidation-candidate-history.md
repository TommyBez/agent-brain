# Storia delle candidate per il consolidamento notturno

Stato aggiornato al 23 settembre 2026: **V5 conclusa senza soddisfare i criteri di accettazione; V6 in preparazione senza chiamate ai modelli**. La configurazione corrente e i controlli ancora pendenti sono descritti in [consolidation-candidate.md](consolidation-candidate.md). Le sezioni seguenti conservano i rapporti storici, incluse le dichiarazioni di stato valide al momento di ciascuno snapshot: non descrivono lo stato corrente della candidata.

Questo documento pubblica soltanto aggregati, configurazioni e metadati. Corpus, diff e audit grezzi restano negli artefatti privati esclusi da Git.
...
# V4 e preparazione V5: snapshot storico del 23 settembre 2026

Il rapporto seguente è conservato com’era prima del consuntivo V5. I suoi controlli riusciti e il suo stato di prova in corso sono evidenze storiche, non risultati della V6.
...
# V5 conclusa e preparazione V6

La prova sequenziale V5 è conclusa: 20 giri e 20 proposte strutturalmente valide, con 12 applicazioni, 5 rifiuti e 3 errori. Jev ha restituito HTTP 503 ai giri 10 e 15; Kimi è andato in timeout al giro 13. Il corpus è passato da 19.317 a 12.584 caratteri. Il costo noto è $2,620150328, con 19 chiamate dal costo ignoto.

L’audit indipendente cieco, sigillato nell’archivio privato `artifacts/consolidation/release-v5/blind-audit`, conferma 29/29 fatti preservati e 12/12 modifiche fedeli. Soltanto 11/12 modifiche sono utili: quella del giro 18 è cosmetica. La coda finale sana e invariata è di due giri, contro i tre richiesti. **La V5 non è soddisfacente e le tre conferme V5 non sono avviabili perché l’audit non è superato.** La riduzione dei caratteri e la fedeltà non sostituiscono il criterio di utilità.

La V6 è in preparazione con politica `consolidation-candidate-v6`, hash `05c4c5aa8a1ecf6a0f96c9e4bc4fdeb36e3f214cca9f3169e1e1fda5d43fc26f`. Il chiarimento Kimi sull’utilità distingue stati storici differenti da vere duplicazioni e una risposta già presente nel before da una risposta effettivamente incorporata. Rinomine e sinonimi senza beneficio di conoscenza non diventano utili; restano ammessi l’eliminazione di vera duplicazione, la rimozione di manutenzione superata e l’inserimento di una risposta documentata, preservando conoscenza e fonti. Jev passa a un massimo di cinque tentativi complessivi entro la stessa finestra di 30 secondi, soltanto per HTTP 408, 429 o 5xx. Le soglie sono invariate.

Nessuna chiamata ai modelli V6 è stata eseguita. Il piano selettivo è in preparazione in `artifacts/consolidation/release-v6/selective-preparation`. La verifica locale preliminare conta 174 test superati e 15 saltati; controlli di codice e build sono ancora pendenti. Restano da verificare i modelli, la stabilità sequenziale e le anteprime su snapshot aggiornati: non si ereditano i risultati di una configurazione precedente.

Resta accettato il rischio di concorrenza senza refresh delle versioni correnti prima della scrittura. Le versioni dello snapshot servono all’audit e non sono nuove condizioni di applicazione. La modalità predefinita resta `preview`; la produzione non è stata attivata.
